...
export class Palette {
    ...
    getNearestColor(colorDistanceCalculator : AbstractDistanceCalculator, rgba, uint32) {
        return this._pointArray[ this.getNearestIndex(colorDistanceCalculator, rgba, uint32) | 0 ];
    }
    ...
    private getNearestIndex(colorDistanceCalculator : AbstractDistanceCalculator, rgba, uint32) : number {
